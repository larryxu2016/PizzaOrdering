...
public class AddToppingCommand implements Command {
    ...
    public AddToppingCommand(HttpServletRequest request,
    ...
    public void saveResults(String user) 
    ...
    public void execute() {
        try {
            ...
            getParams(user);
            pizza.addTopping(params);
            saveResults(user);
        } catch (JSONException | IOException e) {
            Logger.getLogger(AddToppingCommand.class.getName()).log(Level.SEVERE, null, e);
        }
    }
}
