...
public class RemoveItemCommand implements Command {
    ...
    public RemoveItemCommand(HttpServletRequest request,
    ...
    private void getParams(String user) 
        ...
        params.put("line_num", request.getParameter("line_num"));
    }
    ...
    public void execute() {
        try {
            ...
            if (user != null) {
                getParams(user);
                cart.removeItem(cart.getItems().getJSONObject(Integer.parseInt(request.getParameter("line_num"))), params);
                saveResults(user);
            } else { 
            ...
            Logger.getLogger(RemoveItemCommand.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
}
